...
- Design rationale for moving from a per-button `onSessionExpired` delegate to the refresh-closure pattern. (ONB-739)
...
- Structured documentation: `docs/public/` (8 merchant-facing docs) following the Divio documentation system
